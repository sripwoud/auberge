...
- **Apps**: Baikal (calendar/contacts), Colporteur (newsletter-to-feed), FreshRSS (RSS reader), Navidrome (music), Booklore (books), WebDAV (file sharing), YOURLS (URL shortener)
